...
import com.qdc.plugins.baidu.permission.AndPermission;
...
public class BaiduLocation extends CordovaPlugin {
    ...
    public boolean execute(String action, final JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if ("getCurrentPosition".equalsIgnoreCase(action)) {
            ...
            if (ContextCompat.checkSelfPermission(this.webView.getContext(), Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED || ContextCompat.checkSelfPermission(this.webView.getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                AndPermission.with((Activity) this.webView.getContext()).requestCode(REQUEST_GET_PERMISSION).permission(Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.WRITE_EXTERNAL_STORAGE).send();
            } else {
                startLocation();
            }
            ret = true;
